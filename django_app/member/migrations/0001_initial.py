    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirm_password', models.CharField(blank=True, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cert_type', models.CharField(choices=[('univ', '대학인증'), ('grad', '대학원인증'), ('identity', '신분증인증')], max_length=1)),
                ('school', models.CharField(blank=True, max_length=20)),
                ('major', models.CharField(max_length=20, null=True)),
                ('status_type', models.CharField(choices=[('ing', '재학'), ('graduation', '졸업'), ('complete', '수료')], max_length=1, null=True)),
